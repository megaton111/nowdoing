...
const location = ref({
  ...
  options : [
    ...
    { id : 'in' , label : '인천', disabled : false ,
      child : [
        { id : '', label : '중구', disabled : false  } ,
        { id : '', label : '동구', disabled : false  } ,
        { id : '', label : '미추홀구', disabled : false  } ,
        { id : '', label : '연수구', disabled : false  } ,
        { id : '', label : '남동구', disabled : false  } ,
        { id : '', label : '부평구', disabled : false  } ,
        { id : '', label : '계양구', disabled : false  } ,
        { id : '', label : '서구', disabled : false  } ,
        { id : '', label : '강화군', disabled : false  } ,
        { id : '', label : '옹진군', disabled : false  } ,
      ]
    } , 
    { id : 'bu' , label : '부산', disabled : false ,
      child : [
        { id : 'bu1', label : '강서구', disabled : false } ,
        { id : 'bu2', label : '금정구', disabled : false } ,
        { id : 'bu3', label : '기장군', disabled : false } ,
        { id : 'bu4', label : '남구', disabled : false } ,
        { id : 'bu5', label : '동구', disabled : false } ,
        { id : 'bu6', label : '동래구', disabled : false } ,
        { id : 'bu7', label : '부산진구', disabled : false } ,
        { id : 'bu8', label : '북구', disabled : false } ,
        { id : 'bu9', label : '사상구', disabled : false } ,
        { id : 'bu10', label : '사하구', disabled : false } ,
        { id : 'bu11', label : '서구', disabled : false } ,
        { id : 'bu12', label : '수영구', disabled : false } ,
        { id : 'bu13', label : '연제구', disabled : false } ,
        { id : 'bu14', label : '영도구', disabled : false } ,
        { id : 'bu15', label : '중구', disabled : false } ,
        { id : 'bu16', label : '해운대구', disabled : false } ,
      ]
    } , 
